                    ...
                    >
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          >
                            {getCategoryData(faq.category)?.name || faq.category}
                          </span>
