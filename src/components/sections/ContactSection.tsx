...
import { Phone, Mail, MapPin, MessageSquare, CheckCircle, AlertCircle, Loader } from 'lucide-react';
...
const ContactFormSchema = Yup.object().shape({
  ...
  message: Yup.string().min(10, 'پیام باید حداقل 10 کاراکتر باشد').required('پیام الزامی است'),
});
    ...
    <section id="contact" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            <h3 className="text-2xl font-bold mb-6 text-gray-800">پیام خود را ارسال کنید</h3>
            ...
            <Formik
              ...
              onSubmit={async (values: ContactFormValues, { resetForm }) => {
                try {
                  ...
                  setFormStatus('error');
                  const errorMsg = error instanceof Error ? error.message : 'خطا در ارسال پیام';
                ...
                <Form className="relative">
                  ...
                  {formStatus === 'success' && (
                    ...
                    >
                      ...
                      <h4 className="text-xl font-bold text-green-600">با تشکر!</h4>
                  ...
                  {formStatus === 'error' && (
                    ...
                    >
                      ...
                      <h4 className="text-xl font-bold text-red-600">خطا در ارسال پیام</h4>
                      <p className="text-gray-700">{statusMessage}</p>
                      <button
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                      ...
                      <Field
                        ...
                        id="name"
                        name="name"
                        className={`w-full border ${touched.name && errors.name ? 'border-red-500' : 'border-gray-300'} rounded-lg p-3 focus:ring-2 focus:ring-primary-300 focus:border-primary-500 outline-none transition-colors`}
                    ...
                    <div className="mb-6">
                      ...
                      />
                      <ErrorMessage name="phone" component="p" className="text-red-500 mt-1 text-sm" />
                    </div>
                  </div>
                  ...
                  <div className="mb-6">
                    ...
                    <Field
                      ...
                      id="subject"
                      name="subject"
                      className={`w-full border ${touched.subject && errors.subject ? 'border-red-500' : 'border-gray-300'} rounded-lg p-3 focus:ring-2 focus:ring-primary-300 focus:border-primary-500 outline-none transition-colors`}
                  ...
                  <div className="mb-6">
                    ...
                    <Field
                      ...
                      name="message"
                      rows={5}
                      className={`w-full border ${touched.message && errors.message ? 'border-red-500' : 'border-gray-300'} rounded-lg p-3 focus:ring-2 focus:ring-primary-300 focus:border-primary-500 outline-none transition-colors resize-none`}
                  ...
                  <button
                    ...
                    className={`btn btn-primary w-full py-3 flex items-center justify-center ${(isSubmitting || formStatus === 'submitting') ? 'opacity-70 cursor-not-allowed' : ''}`}
                  >
          ...
          >
            <div className="bg-gradient-to-br from-blue-500 to-purple-600 text-white rounded-xl shadow-md p-8 h-full">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="opacity-90">۰۲۱-۱۲۳۴۵۶۷۸</p>
                    <p className="opacity-90">۰۹۱۲۳۴۵۶۷۸۹</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="opacity-90">info@moojpayam.com</p>
                    <p className="opacity-90">support@moojpayam.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="opacity-90">تهران، خیابان ولیعصر، برج آسمان، طبقه ۱۰، واحد ۴</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-10 flex items-center">
                ...
                <p className="opacity-90">پشتیبانی آنلاین: ۲۴ ساعته، ۷ روز هفته</p>
              </div>
            </div>
          </motion.div>
        </div>
