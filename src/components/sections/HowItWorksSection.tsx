      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-20 relative rounded-3xl overflow-hidden">
          <img
            ...
            alt="ارسال پیامک انبوه تبلیغاتی و خدماتی بر اساس نقشه شهری"
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-primary-500/90 to-transparent flex items-center">
            <div className="max-w-2xl p-12">
              ...
              >
                رشد ۳۰۰٪ فروش با تبلیغات پیامکی منطقه‌ای
              </motion.h3>
              <motion.p
                initial={{ opacity: 0, x: -50 }}
                whileInView={{ opacity: 1, x: 0 }}
              ...
              >
                با ارسال پیامک تبلیغاتی منطقه‌ای به مخاطبان هدف در محدوده
                جغرافیایی کسب‌وکارتان، بازدید و فروش خود را به‌صورت چشمگیری
                تقویت کنید. پیامک انبوه منطقه‌ای با نرخ تبدیل تا ۳۰۰٪ بالاتر از
                روش‌های تبلیغاتی سنتی، راهکاری مؤثر برای جذب مشتریان محلی است.
                با استفاده از ارسال اس ام اس انبوه منطقه‌ای، پیام خود را به‌صورت
                هدفمند و سریع به دست مشتریان برسانید و از مزایای تبلیغات اس ام
                اسی منطقه‌ای بهره‌مند شوید
              </motion.p>
              <motion.div
                initial={{ opacity: 0, x: -50 }}
                whileInView={{ opacity: 1, x: 0 }}
